class PlatformConfig {
  ...
  factory PlatformConfig.fromJson(Map<String, dynamic> json) {
    return PlatformConfig(
      ...
      heroVideoReplaceLowBandwidth: json['hero_video_replace_low_bandwidth'] ?? true,
      ...
      offlinePaymentInstructionsEn: json['offline_payment_instructions_en'] ?? '',
      offlinePaymentInstructionsAr: json['offline_payment_instructions_ar'] ?? '',
