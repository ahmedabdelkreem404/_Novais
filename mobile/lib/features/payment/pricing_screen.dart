...
final _offlineRequestsProvider =
  ...
  return data
      .map((e) =>
          OfflinePaymentRequest.fromJson((e as Map).cast<String, dynamic>()))
      .toList();
});
      ...
      child: Column(
        ...
        children: [
          ...
          if ((plan.priceEgp ?? 0) > 0)
            ...
            NvButton(
                label: l10n.t('current_plan'), primary: false, onTap: () {}),
        ],
      ),
    );
  }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
                '${l10n.t(planData['billing_cycle'] ?? 'monthly')} · $amount ${l10n.t('egp')}'),
          ],
        ),
      ),
    );
      ...
      children: [
        ...
        ...items.take(3).map((item) => Card(
              ...
              child: ListTile(
                ...
                subtitle:
                    Text('${item.status} · ${item.amount} ${item.currency}'),
              ),
            )),
      ],
    );
