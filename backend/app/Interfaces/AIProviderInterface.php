...
interface AIProviderInterface
{
    ...
    public function generateLessonContent(string $topic, string $subTopic, string $language, string $courseType = 'Text', string $level = 'Beginner', mixed $blueprint = null, array $blueprintFields = []): array;
